...
import static mvc.modelo.Modelo.HORA_INPUT;
import static mvc.modelo.Modelo.formatter;
...
public class ControladorPlanificarCarrera {
    ...
    /**
     * Constructor del main.java.mvc.controlador de planificación de carreras.
