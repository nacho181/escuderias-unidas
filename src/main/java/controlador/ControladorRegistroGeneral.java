 ...
 * Implementa la lógica de control entre la main.java.vista (interfaz gráfica) y el main.java.modelo de datos.
...
public class ControladorRegistroGeneral {
     ...
     * Cada botón activa una main.java.vista o ejecuta un metodo de registro correspondiente.
     */
    ...
    /**
     * Registra un nuevo auto, evitando duplicados por main.java.modelo.
     */
