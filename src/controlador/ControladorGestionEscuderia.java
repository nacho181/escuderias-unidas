...
public class ControladorGestionEscuderia {
    ...
    private void inicializarEventos() {
        ...
        vista.getGestionEscuderia().getEnviarButton().addActionListener(e -> seleccionarEscuderia());
        vista.getGestionEscuderia().getVolverButton().addActionListener(e -> {vista.mostrarPanel("menu");modelo.getModeloGestionEscuderias().setEscuderiaSeleccionada(null);
        });
        // Volver desde "Escudería Seleccionada"
        vista.getEscuderiaSeleccionada().getVolverButton().addActionListener(e -> {vista.mostrarPanel("escuderiaGestion");modelo.getModeloGestionEscuderias().setEscuderiaSeleccionada(null);
            limpiarCampoEscSelecc();
        });
        // Registrar Piloto
        vista.getEscuderiaSeleccionada().getRegistrarPilotoButton().addActionListener(e -> vista.mostrarPanel("escuderiaPiloto"));
        vista.getRegistrarPilotoEscuderia().getRegistrarButton().addActionListener(e -> registrarPiloto());
        vista.getRegistrarPilotoEscuderia().getVolverButton().addActionListener(e -> {vista.mostrarPanel("escuderiaSeleccionada");limpiarCampoPiloto();});

        // Registrar Mecánico
        vista.getEscuderiaSeleccionada().getRegistrarMecanicoButton().addActionListener(e -> vista.mostrarPanel("escuderiaMecanico"));
        vista.getRegistrarMecanicoEscuderia().getRegistrarButton().addActionListener(e -> registrarMecanico());
        vista.getRegistrarMecanicoEscuderia().getVolverButton().addActionListener(e -> {vista.mostrarPanel("escuderiaSeleccionada");limpiarCampoMecanico();});

        // Registrar Auto
        vista.getEscuderiaSeleccionada().getRegistrarAutoButton().addActionListener(e -> vista.mostrarPanel("escuderiaAuto"));
        vista.getRegistrarEscuderiaAuto().getRegistrarButton().addActionListener(e -> registrarAuto());
        vista.getRegistrarEscuderiaAuto().getVolverButton().addActionListener(e -> {vista.mostrarPanel("escuderiaSeleccionada");limpiarCampoAuto();});
    }
